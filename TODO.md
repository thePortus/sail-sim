...
* New broadside system.... closed & waiting (not ready)... open (ready).... firing... reloading (closed & not ready)... waiting & closed (not ready)
* Add better cannon impact on water (since we have the new shader), better cannon fire
...
* Add damage system, hull port/starboard/bow/stern/sails/crew... add repairing
* True combat system
* Add sailors on deck
* Add ship names
