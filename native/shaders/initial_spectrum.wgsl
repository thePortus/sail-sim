// Ocean-FFT initial spectrum: JONSWAP h0(k) + directional spreading.
// Copied VERBATIM from the browser client so the native port proves 1:1 WGSL parity:
//   ../../client/src/app/sailing/services/ocean-fft/wgsl.ts  (INITIAL_SPECTRUM_WGSL)
// Original authors: gasgiant FFT-Ocean, via Popov72's Babylon.js OceanDemo.
// Do not edit here — keep in sync with the client source.
