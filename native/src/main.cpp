...
int main(int argc, char** argv) {
  ...
  scatterSys.init(device, queue, surfaceFormat, geometryDir() + "/scatter");
  ...
  ShipImpRender shipImp = createShipImpRender(device, surfaceFormat);
  TownImpRender townImp = createTownImpRender(device, surfaceFormat);
  ...
  auto townMeshFor = [&](const std::string& file) -> Mesh* {
    ...
    Mesh m = createMesh(device, queue, surfaceFormat, md);
