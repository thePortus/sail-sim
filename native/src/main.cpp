...
int main(int argc, char** argv) {
  ...
  // Procedural audio beds (ocean wash + rain patter). Skipped for headless
  // screenshot runs so CI/tests stay silent.
  audio::System audioSys;
  if (!std::getenv("SAILSIM_SHOT") && !std::getenv("SAILSIM_MUTE")) audioSys.init();
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // intensity; everything fades out on the login screen.
    {
