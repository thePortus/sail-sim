...
describe('JesuitStudyingArea Endpoints', () => {
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should update a single eventLocation by owner', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .set('Authorization', `${ownerToken}`)
      .send({
        duration: 'Updated Test',
      });
    expect(res.status).toEqual(200);
    expect(res.type).toEqual(expect.stringContaining('json'));
    expect(res.body).toHaveProperty('message', 'JesuitStudyingArea was updated successfully.');
  });

  it('UPDATE /api/jesuits-studying-areas/:id should update a single eventLocation by admin', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should update a single eventLocation by editor', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should update reject request without proper authorization', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .send({
        duration: 'Updated Test',
      });
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should update reject request by regular users without privileges', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should update reject request for unknown item', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/9999')
      .set('Authorization', `${ownerToken}`)
      .send({
        duration: 'Updated Test',
      });
    expect(res.status).toEqual(404);
    expect(res.body).toHaveProperty('message', 'Cannot update JesuitStudyingArea with id=9999. Maybe JesuitStudyingArea was not found!');
  });

  it('UPDATE /api/jesuits-studying-areas/:id should reject request with a non-integer for firstCatalogId', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .set('Authorization', `${ownerToken}`)
      .send({
        firstCatalogId: 'test'
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should reject request with a non-integer for studyAreaId', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .set('Authorization', `${ownerToken}`)
      .send({
        studyAreaId: 'test'
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should reject request with a non-string for duration', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .set('Authorization', `${ownerToken}`)
      .send({
        duration: 1
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should reject request with a non-boolean for inSociety', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .set('Authorization', `${ownerToken}`)
      .send({
        inSociety: 1
  ...
  it('UPDATE /api/jesuits-studying-areas/:id should reject request with a non-string for notes', async () => {
    const res = await requestWithSupertest.put('/api/jesuits-studying-areas/' + createdId.toString())
      .set('Authorization', `${ownerToken}`)
      .send({
        notes: 3
