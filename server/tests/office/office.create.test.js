...
describe('Office Create Endpoints', () => {
  ...
  it('CREATE /api/offices should accept valid data from an owner', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
      .set('Authorization', `${ownerToken}`)
      .send({
  ...
  it('CREATE /api/offices should accept valid data from an admin', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
  ...
  it('CREATE /api/offices should reject request from editor', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
  ...
  it('CREATE /api/offices should reject request without proper authorization', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
      .send({
        title: 'Test',
  ...
  it('CREATE /api/offices should reject request from regular users with no privileges', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
  ...
  it('CREATE /api/offices should reject items without title', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
      .set('Authorization', `${ownerToken}`)
      .send({
  ...
  it('CREATE /api/offices should reject items with titles that are not strings', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
      .set('Authorization', `${ownerToken}`)
      .send({
  ...
  it('CREATE /api/offices should reject items with notes that are not strings', async () => {
    const res = await requestWithSupertest
      .post('/api/offices')
      .set('Authorization', `${ownerToken}`)
      .send({
  ...
  it('CREATE /api/offices should log a change', async () => {
    ...
    const changeRes = await requestWithSupertest
      .get(`/api/changes?page=0&size=5&table=Offices&action=Create&itemId=${itemRes.body.id}`)
      .set('Authorization', `${ownerToken}`);
